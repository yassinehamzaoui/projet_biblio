			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="LoginController">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="username" placeholder="Entrer Email" required>
				...
				<div class="pp" style="padding-bottom:50px;margin-top:-142px">
					<form action="register.jsp">
   					<input class="login100-form-btn" style="margin-left:400px;margin-bottom:80px" type="submit" value="Register"/>
					</form>
				</div>
			</div>
		</div>
