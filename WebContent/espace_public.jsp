	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<p style = "font-size:100px">E-bibliothèque</p><br><br><br>
				<p style = "font-size:50px">Bienvenue à l'espace public</p>
				<hr>
				<a href="http://www.fstt.ac.ma/" class="btn btn-default">Vers Site FSTT</a>
				<a href="login.jsp" class="btn btn-default">Vers Espace privé</a>
