              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li class="active"><a  href="ajouterprofesseur.jsp">Ajouter Professeur</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
          ...
          <section class="wrapper">
			...
			<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="AjouterProfesseurController">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nom Professeur</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="nom_prof" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Prenom Professeur</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="prenom_prof" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Adresse Professeur</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="adresse_prof" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Spécialité Professeur</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="specialite_prof" required>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Email</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="email_prof" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Mot de passe</label>
                              <div class="col-sm-10">
                                  <input type="password" class="form-control round-form " name="pass_prof">
                              </div>
                          </div>
					  <div class="upload-btn-wrappern"><br>
					    <input class="btnn" type="submit" value="Ajouter"/><br><br>
					  </div>
                  </div>
                   </form><br>
          		</div><!-- col-lg-12-->      	
