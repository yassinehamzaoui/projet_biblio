              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="supprimerlivres.jsp">Supprimer Des Livres</a></li>
      ...
      <section id="main-content">
          <section class="wrapper">
                  ...
                  <div class="col-md-12">
               	  ...
               	  <br><br>
                  <div class="search">
				  <form id="searchthis"  method="post" action="SupprimerlivresController" style="display:inline;">
				  <input id="namanyay-search-box" name="nomlivre3" size="40" type="text" placeholder="Entrer le nom du livre à supprimer" required style="width:304px;height:36px;"/>
				  <input id="namanyay-search-btn" style = "width:116px;height:36px;" value="Supprimer" type="submit"/>
				  </form>
				  </div>
