      ...
      *********************************************************************************************************************************************************** -->
      <!--main content start-->
            ...
            <div class="row mt"">
				  ...
				  <form id="searchthis"  method="post" action="ModifierlivresController" style="display:inline;">
				  <input id="namanyay-search-box" name="nomlivre4" size="40" type="text" placeholder="Entrer le nom du livre à modifier" required style="width:304px;height:36px;"/>
				  <input id="namanyay-search-btn" style = "width:116px;height:36px;" value="Chercher" type="submit"/>
				  </form>
				  </div><br>
                  <div class="col-md-12">
