                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" onSubmit="return validation(this)" action="ModifierprofilController">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="nom_admin"  required value="<%out.print(e1.getNomEtudiant());%>">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Prenom</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="prenom_admin"  required value="<%out.print(e1.getPrenomEtudiant());%>">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Adresse</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="adresse_admin"  required value="<%out.print(e1.getAddresseEtudiant());%>" >
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Email</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="email_admin"  required value="<%out.print(e1.getEmailEtudiant());%>">
                              </div>
                          </div>
                          <div class="form-group">
