  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Espace Etudiant</b></a>
            <!--logo end-->
                    <!-- settings end -->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
					...
					<%out.println(e1.getPrenomEtudiant());%></h5>
					</h5>
                  <li class="mt">
      ...
      *********************************************************************************************************************************************************** -->
      <!--main content start-->
            ...
            <div class="row mt"">
				  ...
				  <form id="searchthis"  method="post" action="UploadRedirectController" style="display:inline;">
				  <input id="namanyay-search-box" name="nomlivre5" size="40" type="text" placeholder="Entrer le nom du livre à uploader" required style="width:304px;height:36px;"/>
				  <input id="namanyay-search-btn" style = "width:116px;height:36px;" value="Upload" type="submit"/>
				  </form>
				  </div><br>
                  <div class="col-md-12">
                                  ...
                                  <th><i class=" fa fa-edit"></i> Langue Livre</th>
                                   <th><i class=" fa fa-edit"></i> Date De Parution</th>
                                    <th><i class=" fa fa-edit"></i>Nombre De Page</th>
                                     <th><i class=" fa fa-edit"></i>Chemin Du Fichier</th>
                              </tr>
                              </thead>
                              <tbody>
                              <%for (Livre u : list) {%>
                              <tr>
                                  <td><a href="basic_table.html#"><%out.print(u.getTitreLivre());%></a></td>
                                  ...
                                  <td><span class="label label-info label-mini"><%out.print(u.getLangueLivre());%></span></td>
                                   <td><%out.print(u.getDateParution());%></td>
                                    ...
                                    <td><a href="<%out.print(u.getPath());%>">Chemin <%out.print(u.getIdLivre());%></a></td>
                              </tr>
                               <%}%>
                              </tbody>
                          </table>
