...
<%@page import="org.app.controller.SearchController"%>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="espace_professeur.jsp" class="logo"><b>Espace Professeur</b></a>
            <!--logo end-->
                    <!-- settings end -->
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  ...
	                  	  	  <%out.println(msg);%>    
                 			  <div class="search">
							  <form id="searchthis"  method="post" action="MeslivresProfController" style="display:inline;">
                              ...
                              <tr>
                                  ...
                                  <th><i class="fa fa-bookmark"></i> Thème Livre</th>
                                  <th><i class=" fa fa-edit"></i> Langue Livre</th>
                                  <th><i class=" fa fa-edit"></i> Date parution</th>
                                  <th><i class=" fa fa-edit"></i> Nbr_page_livre</th>
                                  <th></th>
                              </tr>
                              </thead>
                              <tbody>
