...
<%@page import="org.app.controller.MeslivresController"%>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active" ><a  href="rechercher.jsp">Rechercher</a></li>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i>Table de recherche</i></h4>
                 			  <div class="search">
							  <form id="searchthis"  method="post" action="MeslivresController" style="display:inline;">
							  <input id="namanyay-search-box" name="nomlivre2" size="40" type="text" placeholder="Search..." required/>
                              ...
                              <tr>
                                  ...
                                  <th><i class=" fa fa-edit"></i>Ajouter à mon espace</th>
                              </tr>
                              </thead>
                              <tbody>
                              <%Livre u = (Livre)session.getAttribute("book");%>
                              <tr>
