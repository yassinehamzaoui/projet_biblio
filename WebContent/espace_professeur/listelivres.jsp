              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active" ><a  href="listelivres.jsp">Liste Des Livres</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="profil.html">Afficher Informations</a></li>
                          <li><a  href="profilmodif.html">Modifier Informations</a></li>
                      </ul>
                  </li>
