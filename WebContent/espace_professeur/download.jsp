      ...
      *********************************************************************************************************************************************************** -->
      <!--main content start-->
            ...
            <div class="row mt"">
				  ...
				  <form id="searchthis" method="post" action="Download2ProfController" style="display:inline;">
                      ...
                      <div class="content-panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                 ...
                                 <td> 
                                 	  <form id="searchthis"  method="post" action="DownloadProfController" style="display:inline;">
