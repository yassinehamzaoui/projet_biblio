      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="espace_etudiant.jsp">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="espace_etudiant/rechercher.jsp">Rechercher</a></li>
                          <li><a  href="espace_etudiant/listelivres.jsp">Liste Des Livres</a></li>
                          <li><a  href="espace_etudiant/ajouterlivres.jsp">Ajouter Des Livres</a></li>
						  <li><a  href="espace_etudiant/upload.jsp">Uploader</a></li>
						  <li><a  href="espace_etudiant/download.jsp">Download</a></li>
						  <li><a  href="espace_etudiant/ajouterprofesseur.jsp">Ajouter Professeur</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="espace_etudiant/afficherprofil.jsp">Afficher Informations</a></li>
                          <li><a  href="espace_etudiant/modifierprofil.jsp">Modifier Informations</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		  ...
		  <div class="col-lg-12">
				  ...
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome&nbsp;&nbsp;Etudiant&nbsp;&nbsp;<%out.println(e1.getNomEtudiant());%>&nbsp;<%out.println(e1.getPrenomEtudiant());%></div></div>
      <!-- **********************************************************************************************************************************************************
