	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<div class="search">
				<form id="searchthis"  method="post" action="SearchController" style="display:inline;">
				<input id="namanyay-search-box" name="nomlivre" size="40" type="text" placeholder="Search..." required/>
				<input id="namanyay-search-btn" value="Search" type="submit"/>
				</form>
				</div>
			<div>
			<a class="btn btn-warning" href="recherche_avancee.jsp">Recherche Avancé</a>
			</div>
			</div>
		</div>
	</div>		
