	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<p style = "font-size:15px">Entrez le nom du livre à chercher :</p>
                </div>
				<hr>
				<div class="search">
				<form id="searchthis" action="SearchController" style="display:inline;" method="post">
				<input id="namanyay-search-box" name="nomlivre" size="40" type="text" placeholder="Search..."/>
				<input id="namanyay-search-btn" value="Search" type="submit"/>
				</form>
				<br>
				<p style="font-size:20px;margin-left:auto;margin-right: auto;display: block;">
				<%Livre book = (Livre)session.getAttribute("book");%>
