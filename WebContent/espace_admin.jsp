  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="espace_etudiant.jsp" class="logo"><b>Espace Admin</b></a>
            <!--logo end-->
                    <!-- settings end -->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="afficherprofil.jsp"><img src="css/espace_etudiant/assets/img/ui-sam.png" class="img-circle" width="60"></a></p>
              	  <h5 class="centered">
					<%
                  ...
                  <li class="mt">
                      <a class="active" href="espace_admin.jsp">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="espace_admin/rechercher.jsp">Rechercher</a></li>
                          <li><a  href="espace_admin/listelivres.jsp">Liste Des Livres</a></li>
                          <li><a href="espace_admin/ajouterlivres.jsp">Ajouter Des Livres</a></li>
                          <li><a href="espace_admin/modifierlivres.jsp">Modifier Des Livres</a></li>
                          <li><a href="espace_admin/supprimerlivres.jsp">Supprimer Des Livres</a></li>
						  <li><a  href="espace_admin/upload.jsp">Uploader</a></li>
						  <li><a  href="espace_admin/download.jsp">Download</a></li>
						  <li><a  href="espace_admin/ajouterprofesseur.jsp">Ajouter Professeur</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="espace_admin/afficherprofil.jsp">Afficher Informations</a></li>
                          <li><a  href="espace_admin/modifierprofil.jsp">Modifier Informations</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		  ...
		  <div class="col-lg-12">
				  ...
				  &nbsp;&nbsp;&nbsp;&nbsp;Welcome&nbsp;&nbsp;Admin&nbsp;&nbsp;<%out.println(e1.getNomAdministrateur());%>&nbsp;<%out.println(e1.getPrenomAdministrateur());%></div></div>
      <!-- **********************************************************************************************************************************************************
